...
{
    public partial class Trafficking : Form
    {
        public Trafficking()
        {
            InitializeComponent();
        ...
        private void saveBtn_Click(object sender, EventArgs e)
        {
            ...
            string Query = "INSERT INTO mysqlcsharp.traffictable (keyword) VALUES ('" + this.TKeyword.Text + "');";

            MySqlConnection conDataBase = new MySqlConnection(constring);
            MySqlCommand cmdDataBase = new MySqlCommand(Query, conDataBase);

            if (TKeyword.Text == "")                                                                                                //CHECK EXISTING KEYWORD
            {
            ...
            {
                cmdDataBase = new MySqlCommand("SELECT * FROM traffictable where keyword='" + this.TKeyword.Text + "'", conDataBase);
                ...
                if (i > 0)
                {
                    MessageBox.Show("Keyword " + TKeyword.Text + " already exist");
                    dbdataset.Clear();
                }
                else
                {
                    try
                    {
                        ...
                        Query = "INSERT INTO mysqlcsharp.traffictable (keyword) VALUES ('" + this.TKeyword.Text + "');";
                        ...
                        da = new MySqlDataAdapter("SELECT keyword FROM mysqlcsharp.traffictable;", conDataBase);
                        ...
                        TKeyword.Text = "";                         //textbox clear code
                        conDataBase.Close();
                    }
        ...
        {
            UpdateTrafficking trafficking = new UpdateTrafficking();
            trafficking.ShowDialog();
        }

        private void deleteBtn_Click(object sender, EventArgs e)
        {
            MySqlConnection conDataBase = new MySqlConnection("server=localhost;uid=root;database=mysqlcsharp;password=;");
            string deleteQuery = "DELETE FROM mysqlcsharp.traffictable WHERE keyword = '" + this.TKeyword.Text + "';";
            conDataBase.Open();
