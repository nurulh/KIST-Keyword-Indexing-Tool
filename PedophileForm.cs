...
{
    public partial class PedophileForm : Form
    {
        public PedophileForm()
        {
            InitializeComponent();
        }

        private void saveBtn_Click(object sender, EventArgs e)                                                                      //INSERT NEW KEYWORD & SAVE
        {
            string constring = "server=localhost;uid=root;database=mysqlcsharp;password=;";
            string Query = "INSERT INTO mysqlcsharp.pedotable (keyword) VALUES ('" + this.Pdkeyword.Text + "');";

            MySqlConnection conDataBase = new MySqlConnection(constring);
            MySqlCommand cmdDataBase = new MySqlCommand(Query, conDataBase);

            if (Pdkeyword.Text == "")                                                                                                //CHECK EXISTING KEYWORD
            {
            ...
            {
                cmdDataBase = new MySqlCommand("SELECT * FROM pedotable where keyword='" + this.Pdkeyword.Text + "'", conDataBase);
                ...
                if (i > 0)
                {
                    MessageBox.Show("Keyword " + Pdkeyword.Text + " already exist");
                    dbdataset.Clear();
                }
                else
                {
                    try
                    {
                        ...
                        Query = "INSERT INTO mysqlcsharp.pedotable (keyword) VALUES ('" + this.Pdkeyword.Text + "');";
                        ...
                        da = new MySqlDataAdapter("SELECT keyword FROM mysqlcsharp.pedotable;", conDataBase);
                        ...
                        Pdkeyword.Text = "";                    //textbox clear code
                        conDataBase.Close();
                    }
        ...
        private void loadBtn_Click(object sender, EventArgs e)                                                 //DISPLAY KEYWORD
        {
            string constring = "server=localhost;uid=root;database=mysqlcsharp;password=;";
            MySqlConnection conDataBase = new MySqlConnection(constring);
        ...
        */
        ...
        {
            PdUpdate updateform = new PdUpdate();
        ...
        private void deleteBtn_Click(object sender, EventArgs e)                                                    //DELETE KEYWORD
        {
            ...
            string deleteQuery = "DELETE FROM mysqlcsharp.pedotable WHERE keyword = '" + this.Pdkeyword.Text + "';";
            conDataBase.Open();
