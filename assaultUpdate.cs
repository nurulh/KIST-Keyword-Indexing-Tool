...
namespace LoginProject
{
    public partial class assaultUpdate : Form
    {
        ...
        {
            string updateQuery = "UPDATE mysqlcsharp.assaulttable SET keyword = '" + this.NAskeyword.Text + "' WHERE keyword='" + this.Askeyword.Text + "'";
