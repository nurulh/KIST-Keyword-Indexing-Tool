...
{
    public partial class MurderForm : Form
    {
        public MurderForm()
        {
            InitializeComponent();
        ...
        private void saveBtn_Click(object sender, EventArgs e)                                                  //INSERT NEW KEYWORDS
        {
            ...
            string Query = "INSERT INTO mysqlcsharp.murdertable (keyword) VALUES ('" + this.Mkeyword.Text + "');";

            MySqlConnection conDataBase = new MySqlConnection(constring);
            MySqlCommand cmdDataBase = new MySqlCommand(Query, conDataBase);

            if (Mkeyword.Text == "")                                                                            //CHECK EXISTING KEYWORD
            {
            ...
            {
                cmdDataBase = new MySqlCommand("SELECT * FROM murdertable where keyword='" + this.Mkeyword.Text + "'", conDataBase);
                ...
                if (i > 0)
                {
                    MessageBox.Show("Keyword " + Mkeyword.Text + " already exist");
                    dbdataset.Clear();
                }
                else
                {
                    try
                    {
                        ...
                        Query = "INSERT INTO mysqlcsharp.murdertable (keyword) VALUES ('" + this.Mkeyword.Text + "');";
                        ...
                        da = new MySqlDataAdapter("SELECT keyword FROM mysqlcsharp.murdertable;", conDataBase);
                        ...
                        Mkeyword.Text = "";             //textbox clear code
                        conDataBase.Close();
                    }
        ...
        private void loadBtn_Click(object sender, EventArgs e)                                                      //LOAD BUTTON AND DISPLAY DATAGRIDVIEW
        {                 
                string constring = "server=localhost;uid=root;database=mysqlcsharp;password=;";
                MySqlConnection conDataBase = new MySqlConnection(constring);
        ...
        */
        ...
        {
            MUpdate mupdateForm = new MUpdate();
        ...
        private void deleteBtn_Click(object sender, EventArgs e)                                        //DELETE KEYWORD
        {
            ...
            string deleteQuery = "DELETE FROM mysqlcsharp.murdertable WHERE keyword = '" + this.Mkeyword.Text + "';";
            conDataBase.Open();
